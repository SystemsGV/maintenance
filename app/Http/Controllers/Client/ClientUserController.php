...
class ClientUserController extends Controller
{
    ...
    {
        abort_if(! $request->user()->can('ver usuarios cliente'), 401);
    ...
    {
        abort_if(! request()->user()->can('crear usuario cliente'), 401);
    ...
    public function store(StoreClientRequest $request)
    {
        ...
        if (empty($request->companies)) {
            return redirect()
                ...
                ->success('Client created', 'A new cliente was successfully created. Now you can create a company for the client.');
        }
    ...
    {
        abort_if(! request()->user()->can('editar usuario cliente'), 401);
    ...
    {
        abort_if(! request()->user()->can('archivar usuario cliente'), 401);
    ...
    {
        abort_if(! request()->user()->can('restaurar usuario cliente'), 401);
