...
const TasksIndex = () => {
  ...
  return (
    <>
      ...
      {can("crear tarea") && <CreateTaskDrawer />}
      <EditTaskDrawer />
        ...
        {!route().params.archived ? (
          <Grid.Col span={tasksView === "list" ? 9 : 12}>
            {groups.length ? (
                    ...
                    {(provided) => (
                      <div {...provided.droppableProps} ref={provided.innerRef}>
                        <div className={classes.viewport}>
                          ...
                          {!route().params.archived && can("crear grupo de tarea") && (
                            <Button
                              ...
                              style={{ width: "200px" }}
                            >
                              Agregar {tasksView === "list" ? "grupo de tareas" : "grupo"}
                            </Button>
                          )}
                        </div>
                      </div>
              ...
              <EmptyResult title="No se encontraron tareas" subtitle="o ninguno coincide con sus criterios de búsqueda" />
            )}
          </Grid.Col>
        ) : (
          <Grid.Col span={tasksView === "list" ? 9 : 12}>
